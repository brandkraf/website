...
const BENEFITS = [
  { title: "Operational Transparency", desc: "Show clients exactly how their freight is handled.", icon: Truck },
  { title: "Safety Promotion", desc: "Highlight your rigorous safety standards.", icon: ShieldCheck },
  { title: "Driver Recruitment", desc: "Showcase the lifestyle and benefits to attract top talent.", icon: Users },
  { title: "Service Quality", desc: "Visual proof of on-time deliveries and careful handling.", icon: Clock }
];

const CONTENT_TYPES = [
  { title: "Fleet Showcases", desc: "Impressive visuals of your vehicles and facilities." },
  { title: "Day in the Life", desc: "Driver and warehouse worker perspective videos." },
  { title: "Efficiency Demos", desc: "Time-lapses of loading, routing, and delivery." }
];

const FAQS = [
  { q: "Can we shoot inside warehouses?", a: "Yes, we adhere to all safety and confidentiality guidelines while capturing operational footage." },
  { q: "Is this content suited for LinkedIn?", a: "Absolutely, logistics UGC performs exceptionally well for B2B audiences on LinkedIn." }
];
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl">
              ...
              >
                ...
                <h1 className="mb-6">Showcase the Reliable Engine</h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Showcase the reliable engine that keeps businesses moving. UGC humanizes logistics, highlights operational efficiency, and builds immense B2B trust.
                </p>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container-custom">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2>Why UGC for Logistics?</h2>
              <p className="text-muted-foreground mt-4">Build trust and accelerate adoption with authentic operational experiences.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-8 text-lg">
                  We specialize in crafting dynamic, fast-paced content that captures attention and showcases the true value of your logistics network.
                </p>
              ...
              <div className="relative">
                ...
                >
                  <div className="flex items-center gap-4 mb-3">
                    ...
                    <span className="font-semibold text-sm tracking-wide text-primary uppercase">Case Study: Global Freight Network</span>
                  </div>
                  <p className="text-sm text-foreground mb-4 italic leading-relaxed">"Our driver lifestyle campaign solved our recruitment bottleneck."</p>
        ...
        <section className="py-24 bg-primary text-primary-foreground text-center">
          <div className="container-custom max-w-3xl">
            ...
            <p className="text-primary-foreground/80 text-lg mb-10">
              Let's create immersive video content that drives qualified leads and recruits to your business.
            </p>
