...
const BENEFITS = [
  { title: "Financial Literacy", desc: "Educate your audience natively on their feeds.", icon: TrendingUp },
  { title: "Trust Building", desc: "Real users talking about their financial success.", icon: ShieldCheck },
  { title: "Demystify Insurance", desc: "Explain policies simply without industry jargon.", icon: FileText },
  { title: "App Adoption", desc: "Showcase how easy it is to use your fintech product.", icon: Smartphone }
];

const CONTENT_TYPES = [
  { title: "App Walkthroughs", desc: "Screen recordings showing how to invest or save." },
  { title: "Personal Finance Tips", desc: "Creators sharing tips that subtly integrate your service." },
  { title: "Claims Success Stories", desc: "Real stories of insurance working when needed." }
];
      ...
      <main className="flex-grow pt-24">
        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img 
              src="https://images.unsplash.com/photo-1571840615771-acc2e9f42641?q=80&w=2070&auto=format&fit=crop" 
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl">
              ...
              >
                ...
                <h1 className="mb-6">Build Unprecedented Trust</h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Finance is intimidating. UGC creators break down complex financial concepts, building approachability for banks, apps, and insurance firms.
                </p>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container-custom">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2>Why UGC for Finance?</h2>
              <p className="text-muted-foreground mt-4">Consumers trust peers over institutions when it comes to their money.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-8 text-lg">
                  We specialize in creating compliant, engaging content that simplifies financial decisions.
                </p>
              ...
              <div className="relative">
                ...
                >
                  <div className="flex items-center gap-4 mb-3">
                    ...
                    <span className="font-semibold text-sm tracking-wide text-primary uppercase">Case Study: WealthGrow App</span>
                  </div>
                  <p className="text-sm text-foreground mb-4 italic leading-relaxed">"Educational UGC lowered our user acquisition cost drastically."</p>
          ...
          <div className="container-custom max-w-3xl">
            ...
            <div className="space-y-6">
              <div className="bg-card p-6 rounded-2xl border border-border">
                <h4 className="font-semibold mb-2">How do you handle compliance?</h4>
                <p className="text-muted-foreground">We work closely with your legal team to ensure all scripts and final videos meet financial advertising regulations.</p>
              </div>
              <div className="bg-card p-6 rounded-2xl border border-border">
                <h4 className="font-semibold mb-2">Are financial creators expensive?</h4>
                <p className="text-muted-foreground">We utilize a mix of 'finfluencers' and everyday users to balance reach and budget.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-primary text-primary-foreground text-center">
          <div className="container-custom max-w-3xl">
            <h2 className="mb-6 text-primary-foreground">Ready to Build Trust?</h2>
            <p className="text-primary-foreground/80 text-lg mb-10">
              Let's create authentic content that demystifies finance and drives adoption.
            </p>
