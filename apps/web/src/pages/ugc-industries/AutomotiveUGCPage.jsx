...
const BENEFITS = [
  ...
  { title: "Test Drive POV", desc: "Let viewers experience the drive virtually.", icon: Car },
  { title: "Dealership Trust", desc: "Humanize your sales team and build local credibility.", icon: ShieldCheck },
  { title: "Lifestyle Integration", desc: "Show how the vehicle fits into daily life.", icon: Users }
];

const CONTENT_TYPES = [
  { title: "POV Drives", desc: "Immersive driving experiences from the driver's perspective." },
  { title: "Tech Walkthroughs", desc: "Quick tips on using infotainment and safety systems." },
  { title: "Owner Testimonials", desc: "Real stories from satisfied buyers." }
];
      ...
      <main className="flex-grow pt-24">
        ...
        <section className="relative py-20 md:py-32 overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img 
              src="https://images.unsplash.com/photo-1634981297356-f9b4daa98a92?q=80&w=2070&auto=format&fit=crop" 
              alt="Automotive" 
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl">
              ...
              >
                ...
                <h1 className="mb-6">Drive Sales with Authentic Automotive UGC</h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  From feature demonstrations to the thrill of a test drive, UGC puts potential buyers in the driver's seat, driving dealership foot traffic and brand loyalty.
                </p>
        ...
        <section className="py-20 bg-muted/30">
          <div className="container-custom">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2>Why UGC for Automotive?</h2>
              <p className="text-muted-foreground mt-4">Authentic content bridges the gap between the showroom and the consumer, driving transparency and trust.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-8 text-lg">
                  We specialize in creating content formats that resonate specifically with automotive audiences and potential buyers.
                </p>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-8 -left-8 bg-card p-6 rounded-2xl border border-border shadow-xl max-w-xs hidden md:block">
                  ...
                  <p className="text-sm text-muted-foreground italic">"Our feature-highlight Reels consistently bring informed buyers into the showroom."</p>
                  <p className="text-xs font-bold mt-2">— Metro Motors</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 bg-primary text-primary-foreground text-center">
          <div className="container-custom max-w-3xl">
            ...
            <p className="text-primary-foreground/80 text-lg mb-10">
              Let's create authentic content that showcases your vehicles and drives real showroom traffic.
            </p>
